...
The "Calendar" dimension table contains all the dates from some point in the past (2021 Jan 1) up to some point in the future (2021 Dec 31) - a period relevant to business users.   
b) The business key is the attribute that is known in the operational system by the business users. The business key in "Calendar" demencion for easy query development, an integer is provided taking the format YYYYMMD.
